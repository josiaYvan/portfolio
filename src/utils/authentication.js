 ...
 *
 */
const APP_USER_STORAGE = 'BEACH-RADIOEMIA-USER-STORAGE';
const APP_ACCESS_TOKEN = 'BEACH-RADIOEMIA-ACCESS-TOKEN';
const APP_REFRESH_TOKEN = 'BEACH-RADIOEMIA-REFRESH-TOKEN';
